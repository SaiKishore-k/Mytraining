const books = [
    ...
    },
    {
      ...
      thumbnailUrl:
        ...
        shortDescription:'Specification by Example is a set of process patterns that facilitate change in software products to ensure the right product is delivered effectively',
        longDescription:'Specification by Example is a set of process patterns that facilitate change in software products to ensure the right product is delivered effectively. This book is based on the research of 30 teams that implemented 50 projects',
      status: "PUBLISH",
      authors: ["Gojko Adzic"],
    ...
    },
    {
      ...
      thumbnailUrl:
        ...
        shortDescription:'New web applications require engaging user-friendly interfaces and the cooler, the better',
      longDescription:
    ...
    
    {
      ...
      shortDescription:'There is a great deal of wisdom in a crowd, but how do you listen to a thousand people talking at once  Identifying the wants, needs, and knowledge of internet users can be like listening to a mob.',
        longDescription:
    ...
    },
    {
      ...
      shortDescription:
        "Zend Framework in Action is a comprehensive tutorial that shows how to use the Zend Framework to create web-based applications and web services.",
      longDescription:
    ...
    },
    {
      ...
      shortDescription:
        "Enterprise OSGi shows a Java developer how to develop to the OSGi Service Platform Enterprise specification.",
      longDescription:
    ...
    },
    {
      ...
      shortDescription:
        "Hello! Flex 4 progresses through 26 self-contained examples selected so you can progressively master Flex. ",
      longDescription:
    ...
    },
    {
      ...
      shortDescription:'In complex software projects, managing the development process can be as critical to success as writing the code itself. ',
        longDescription:
    ...
    },
    {
      ...
      shortDescription:
        "Brownfield Application Development in .Net shows you how to approach legacy applications with the state-of-the-art concepts, patterns.",
      longDescription:
   ...
   
    {
      ...
      shortDescription:'Taming Jaguar is part of the PowerBuilder Developers series',
        longDescription:
    ...
    },
    {
      ...
      shortDescription:'3D User Interfaces with Java 3D',
        longDescription:
    ...
    },
    {
      ...
      thumbnailUrl:
        ...
        shortDescription:"JSTL is an important simplification of the Java web platform.",
        longDescription:
